			...
			<div class="row justify-content-start align-items-center">
				...
				<div class="offset-lg-1 col-lg-5">
					<div class="main_title text-left">
						...
						<p>
                            Sistem ini berbasis pure website yang dikerjakan oelah mahasiswa magang asal Universitas Sahid Surakarta
                            yang ditujukan untuk Cv.Seven.Inc
						</p>
						<a class="primary_btn" href="index1.php"><span>Gaji</span></a>
						<a class="primary_btn tr-bg" href="index2.php"><span>Honor</span></a>
					</div>
				</div>
			</div>
		</div>
